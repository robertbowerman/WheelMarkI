...
function coverLength() = 103.2; 
function coverWidth() = 12.0; // same as sawn 12 x 12 sawn steel
function coverThickness() = 2.0;
holeFromEnd = 15.57; 
interHoleXGap = coverLength() - (holeFromEnd * 2);
holeDiameter = 0.94+0.3;

translated(106*x,[0:2])     // lots of covers 3 in a column 
