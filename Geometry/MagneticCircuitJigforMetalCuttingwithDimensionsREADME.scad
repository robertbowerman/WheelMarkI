...
The permanent magnets are 9.92, 9.93, 9.94, 9.95,9.96.  So make holes 9.95. Will need to experiment to ensure snug fit, without rattle and assemble-able. Perhaps use 0.3mm one way and 0.1mm the other way.  Calibration test may be needed, adjusting extrusion rate. 
