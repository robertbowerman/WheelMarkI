...
module rotorLongBarInNylon(){
    rotorLongBar();
    translate([-justFitSize/2, -justFitSize/2, -justFitSize/2])color("yellow",0.6)
    box([rotorLongBarLength()+justFitSize, rotorLongBarWidth()+justFitSize, rotorLongBarHeight()+justFitSize], anchor = [-1,-1,-1]);
